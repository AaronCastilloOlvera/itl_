...
<html>
<head>
<title>Instituto Tecnológico de la Laguna</title> </head>
	<meta charset="UTF-8">
    ...
    <section class="cid-rD7PmpFJj8" id="footer2-7" 
    		 style="padding-bottom:10px; background:#363637;border-width: 8px;" >
        ...
        <div class="media-container-row content mbr-white">
            ...
            <div class="col-12 col-md-6 foto_contenedor">
					<div class="contenedor">
						<embed src="img/ubicacionITL.jpeg" alt="Ubicación" width="100%" height="250px" class="foto_ubicacion" />
						
						<a href="ubicacion.php" class="txt_centrado">Ver ubicación</a>
 					</div>
