...
<head>
	...
	<link rel='icon' type='image/jpeg' href='img/itl.jpeg' />
	<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1">
	<meta name="description" content="Página del Instituto Tecnológico de la Laguna">
	...
	<script>
	$(document).ready(function() { setTimeout(function() { $(".contenido_portal").fadeIn(5000); },500); });
	$(document).ready(function() { setTimeout(function() { $(".texto").fadeIn(1000); },50); });
	</script>
	
	<!-- CSS -->
    <link href="img/tecnmicono.ico" rel="shortcut icon">
	...
	<style>
		div.dropdown-menu a:hover{ background-color: #363636; align-content: center;}
	...
	<style> /* Estilo del carrucel del carrucel */
...
<body>
	...
	<div class="u-noPaddingContainer contenedorGobierno" style="z-index:1000;">
		<div class="container-cabecera" style="padding-bottom:10px;padding-top:1%;">
				...
				<div class="col-md-12" style="max-width:90%; " >
					<div class="d-inline-block ipnLogo-enlace" style="">
						...
						<a href="https:/www.itlalaguna.edu.mx/" target="_blank" style="z-index:2001" id="pleca_3">
							<img src="img/itl2.jpeg" alt="ITL" style="width:6%;height:auto; min-width:70px" class="plecaGob gob">
						</a>
				...
				<ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
					...
					<li class="nav-item dropdown" >
						...
						<div class="dropdown-menu" style="background:#363637;">
							...
							<a class="text-black dropdown-item" href="http://www.itlalaguna.edu.mx/2014/nuestro%20tec/misionvision.pdf">MISIÓN Y VISIÓN</a>
							<a class="text-black dropdown-item" href="#">UBICACIÓN E INFRAESCTRUCTURA</a>
							...
							<a class="text-black dropdown-item" href="https://docs.google.com/forms/d/e/1FAIpQLSeE8OPXE5YSXIcA0zLvfCnaHtY0NQrbtSEr9VVMn8ZavzT_iA/viewform#response=ACYDBNiyCA6p87VDbN4lu-wVyLdVOv5qkOKwqxQXMwKijoJdEsQXK53UB9bS5t4">BUZON DE QUEJAS Y SUGERENCIAS</a>
							<a class="text-black dropdown-item" href="http://www.itlalaguna.edu.mx/2014/Nuestro%20Tec/codigoetica.pdf">CÓDIGO DE ÉTICA Y CONDUCTA</a>
							<a class="text-black dropdown-item" href="#">TRANSPARENCIA</a>
	
						</div>
					</li>
					
					<li class="nav-item dropdown" style="border-color:#363637;">
						<a  href="#" class="nav_link link text-black dropdown-toggle" style="outline-style:none;border-color:#363637;" data-toggle="dropdown-submenu" aria-expanded="true">
						Oferta Educativa
						</a>
					 <div class="dropdown-menu" style="background:#363637;border-color:#363637;"> 
					 <ul class="navbar-nav nav-dropdown dropdown-item" style="background:#363637;border-color:#363637;" data-app-modern-menu="true">
								<li class="nav-item dropdown" style="background:#363637;border-color:#363637;">
									 <a class=" link text-black dropdown-toggle dropdown-item" style="background:#363637;border-color:#363637;" href="#" data-toggle="dropdown-submenu" aria-expanded="false">EDUCACION A DISTANCIA</a>
										<div class="dropdown-menu" style="background:#363637;border-color:#363637;">
											<a class="text-black dropdown-item" style="background:#363637;border-color:#363637;" href="#" >P.A. Energia Electrica</a>
											<a class="text-black dropdown-item" style="background:#363637;border-color:#363637;" href="#" >P.A. Energia Renovable</a>
										 </div>
										</li>
					</ul>

					 <ul class="navbar-nav nav-dropdown dropdown-item" style="background:#363637;" data-app-modern-menu="true">
								<li class="nav-item dropdown" style="background:#363637;">
									 <a class=" link text-black dropdown-toggle dropdown-item" style="background:#363637;" href="#" data-toggle="dropdown-submenu" aria-expanded="false">NIVEL LICENCIATURA</a>
										<div class="dropdown-menu" style="background:#363637;">
											<a class="text-black dropdown-item" href="#" >ING. SISTEMAS COMPUTACIONALES</a>
											<a class="text-black dropdown-item" href="#" >ING. ELÉCTRICA</a>
											<a class="text-black dropdown-item" href="#" >ING. EN ENERGÍAS RENOVABLES</a>
											<a class="text-black dropdown-item" href="#" >ING. INDUSRIAL</a>
											<a class="text-black dropdown-item" href="#" >ING. MECÁNICA</a>
											<a class="text-black dropdown-item" href="#" >ING. MECATRÓNICA</a>
											<a class="text-black dropdown-item" href="#" >ING. QUÍMICA</a>
											<a class="text-black dropdown-item" href="#" >LIC. ADMINISTRACION</a>
											<a class="text-black dropdown-item" href="#" >ING. GESTIÓN EMPRESARIAL</a>
	
										 </div>
								 </li>
					 </ul>
						 <!-- <a class="text-black dropdown-item" href="#">Educacion a distancia</a> -->
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" style="background:#363637;">
							<a class="text-black dropdown-item" href="#">SEMESTRE DE NIVELACIÓN</a>
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" style="background:#363637;">
							...
							<ul class="navbar-nav nav-dropdown dropdown-item" style="background:#363637;" data-app-modern-menu="true">
								<li class="nav-item dropdown" style="background:#363637;">
									 <a class=" link text-black dropdown-toggle dropdown-item" style="background:#363637;" href="#" data-toggle="dropdown-submenu" aria-expanded="false">DIV. DE ESTUDIOS PROFESIONALES</a>
										<div class="dropdown-menu" style="background:#363637;">
											<a class="text-black dropdown-item" href="#" >COORDINACIÓN DE TITULACIÓN</a>
											<a class="text-black dropdown-item" href="#" >HORARIO MATERIAS</a>
											<a class="text-black dropdown-item" href="#" >REINGRESO LICENCIATURA</a>
											<a class="text-black dropdown-item" href="#" >VERANOS LICENCIATURA</a>
											<a class="text-black dropdown-item" href="#" >REINGRESO POSGRADO</a>
											<a class="text-black dropdown-item" href="#" >REINGRESO A DISTANCIA</a>
										 </div>
								 </li>
							</ul>
							<ul class="navbar-nav nav-dropdown dropdown-item" style="background:#363637;" data-app-modern-menu="true">
								<li class="nav-item dropdown" style="background:#363637;">
									 <a class=" link text-black dropdown-toggle dropdown-item" style="background:#363637;" href="#" data-toggle="dropdown-submenu" aria-expanded="false">SERVICIOS ESCOLARES</a>
										<div class="dropdown-menu" style="background:#363637;">
											<a class="text-black dropdown-item" href="#" >CONVOCATORIAS</a>
											<a class="text-black dropdown-item" href="#" >SEGURO FALCUTATIVO</a>
											<a class="text-black dropdown-item" href="#" >ESTATUS ALUMNADO</a>
											<a class="text-black dropdown-item" href="#" >REQUISITOS CERTIFICADO</a>
											<a class="text-black dropdown-item" href="#" >REGLAMENTO</a>
											<a class="text-black dropdown-item" href="#" >TITULACIÓN</a>
										 </div>
								 </li>
							</ul>
							
						  <!--  <a class="text-black dropdown-item" href="#">SERVICIOS ESCOLARES</a>
							<a class="text-black dropdown-item" href="#">DESARROLLO ACADÉMICO</a>
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" style="background:#363637;">
							...
							<a class="text-black dropdown-item" href="#">SISTEMA DE G.DE IGUALDAD DE GÉNERO</a>
